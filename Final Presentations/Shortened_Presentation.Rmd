...
---
## By using an interaction between launch angle and exit velocity in our GAM, we were able to capture the true distribution of wOBA, such as the band of singles and clump of home runs
.pull-left[
**Actual relationship**
