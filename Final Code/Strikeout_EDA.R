####################################################################################################################################
#This file explores the relationship of a player's attack angle and average launch angle with their strikeout rate. 
#Here we begin the EDA process, but we will later create a model to determine if there are certain attack angles 
#that may not be worth the benefits of a higher attack angle. 
...
#BASIC RELATIONSHIP BETWEEN ATTACK/LAUNCH ANGLE AND K%

# Begin by creating a scatterplot of average launch angle versus strikeout percentage and attack angle versus 
#strikeout percentage. Each point represents one player's season where they had at least 50 batted balls. 
#We see a stronger relationship between attack angle and strikeout percentage (correlation ~0.313). 
#This emphasizes why we should be using attack angle - it better correlates with what a player is doing 
...
#HOW DOES CHANGING ATTACK ANGLE CORRELATE WITH CHANGE IN K%?
...
#We will start to work on a model for strikeout probability 
